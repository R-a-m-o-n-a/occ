...
const config = {
  ...
  moduleNameMapper: {
    '\.(css|less|scss)$': '<rootDir>/src/__mocks__/emptyMock.js',
    'Map\.jsx': '<rootDir>/src/__mocks__/MapMock.jsx',
    'Quiz\.jsx': '<rootDir>/src/__mocks__/QuizMock.jsx',
    'env-vars\.js': '<rootDir>/src/__mocks__/envVarMock.js',
  },
